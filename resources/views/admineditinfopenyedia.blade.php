                                                        ...
                                                        <div class="devit-card-custom">
                                                            <form id="formUpload">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="varchar" class="form-control" id="npwp_perusahaan" name="npwp_perusahaan" value="{{$data->npwp_perusahaan}}" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Email Perusahaan</h4>
                                                                    <input type="varchar" class="form-control" id="email_penyedia" name="email_penyedia" value="{{$data->email_penyedia}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Alamat Perusahaan</h4>
                                                                    <textarea class="form-control" id="alamat_penyedia" name="alamat_penyedia">{{$data->alamat_penyedia}}</textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Pengurus Perusahaan</h4>
                                                                    <textarea class="form-control" id="pengurus_penyedia" name="pengurus_penyedia">{{$data->pengurus_penyedia}}</textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Keuangan Perusahaan</h4>
                                                                    <textarea class="form-control" id="keuangan_penyedia" name="keuangan_penyedia">{{$data->keuangan_penyedia}}</textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Kapasitas Perusahaan</h4>
                                                                    <textarea class="form-control" id="kapasitas_penyedia" name="kapasitas_penyedia">{{$data->kapasitas_penyedia}}</textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Sarana Prasarana Perusahaan</h4>
                                                                    <textarea class="form-control" id="saranaprasarana_penyedia" name="saranaprasarana_penyedia">{{$data->saranaprasarana_penyedia}}</textarea>
                                                                </div>
