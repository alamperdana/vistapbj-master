...
<head>
    ...
    <title> Admin | Informasi Data Pengguna</title>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="{{route('admin')}}"><span class="mini-sub-pro">Info Data Pengguna</span></a></li>
                            </ul>
                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Pengguna</h1>
                                </div>
                            </div>
