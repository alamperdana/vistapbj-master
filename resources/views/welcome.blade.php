    ...
    <div class="ckav-body">
        ...
        *************************************************************
        ...
        <div class="intro-section flex-cc">
            ...
            <div class="container zindex-2 typo-light">
                <div class="intro-text width-40" data-ckav-smd="width-100 align-center">
                    <h2 style="color:black" class="heading xlarge bold-600 margin-b-25" data-ckav-smd="large">VISTA <br data-ckav-smd="display-none">PBJ</h2>
                    <p style="color:black;" class="heading-sub mini bold-300 margin-b-40" data-ckav-smd="mini margin-b-40">Verifikasi Informasi Sertifikat Keterampilan, Keahlian & Sisa Kemampuan Paket Perusahaan Pengadaan Barang Jasa</p>
                </div>

                <!-- SOCIAL ICONS -->
                <div class="social-section display-none" data-ckav-smd="display-flex flex-cc margin-t-40">
                    <div class="inner-wrapper">
                        ...
                        <a href="https://instagram.com/bagianpbjap_jambikota?igshid=YmMyMTA2M2Y=" class="button button-icon radius-full margin-r-10 color-button-white border-glass"><i class="fab fa-instagram"></i></a>
            ...
            <div class="bg-holder zindex-0">
                ...
                <!-- OVERLAY -->
                <b data-bgholder="overlay" class="full-wh zindex-2" data-radial-gradient="rgba(0,0,0, 0)|rgba(208,9,0, 0.0)"></b>
