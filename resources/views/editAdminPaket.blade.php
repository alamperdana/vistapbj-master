...
.a{
                                                        ...
                                                        <div class="devit-card-custom">
                                                            <form id="formUpload">
                                                                ...
                                                                <div class="form-group">
                                                                    <h4>Kode Paket</h4>
                                                                    <input type="text" class="form-control" id="kode_paket" name="kode_paket" value="{{$data->kode_paket}}" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Jenis Paket</h4>
                                                                    <select id="jenis_paket" name="jenis_paket" class="form-control" selected>
                                                                ...
                                                                <div class="form-group">
                                                                    <h4>Tahun</h4>
                                                                    <input type="number" class="form-control" id="tahun" name="tahun" value="{{$data->tahun}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Bulan</h4>
                                                                    <input type="number" class="form-control" id="bulan" name="bulan" value="{{$data->bulan}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Awal Pemilihan</h4>
                                                                    <input type="date" class="form-control" id="awal_paket" name="awal_paket" value="{{$data->awal_paket}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Akhir Pemilihan</h4>
                                                                    <input type="date" class="form-control" id="akhir_paket" name="akhir_paket" value="{{$data->akhir_paket}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Awal Kontrak</h4>
                                                                    <input type="date" class="form-control" id="awal_kontrak_paket" name="awal_kontrak_paket" value="{{$data->awal_kontrak_paket}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Akhir Kontrak</h4>
                                                                    <input type="date" class="form-control" id="akhir_kontrak_paket" name="akhir_kontrak_paket" value="{{$data->akhir_kontrak_paket}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Pagu Paket</h4>
                                                                    <input type="number" class="form-control" id="pagu_paket" name="pagu_paket" value="{{$data->pagu_paket}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>HPS Paket</h4>
                                                                ...
                                                                <div class="form-group">
                                                                    <h4>SKP</h4>
                                                                    <input type="text" class="form-control" id="skp" name="skp" value="{{$data->skp}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <h4>Paket Berjalan</h4>
                                                                    <select id="paket_berjalan" name="paket_berjalan" class="form-control" selected>
    ...
    <script>
        ...
        $('#paket_berjalan').val({!! json_encode($data->paket_berjalan) !!});

          $('#formUpload').on('submit', function(event){
            event.preventDefault();
            var datas = new FormData(this);
                $.ajax({
                    url: '/adminpaketerjalan/store',
                    data: datas,
                    cache: false,
                    contentType: false,
                    processData: false,
