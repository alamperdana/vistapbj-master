  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
            <p class="lead fw-normal mb-0 me-3" style="color:rgb(71, 255, 4)">Login Akun</p>
          ...
          <div class="divider d-flex align-items-center my-4">
            ...
            <form style="width: 23rem;" height="1000rem;" method="POST" action="{{ route('login') }}">
                     @csrf
          ...
          <button type="submit" class="btn btn-primary">
            ...
            <p class="small fw-bold mt-2 pt-1 mb-0" style="color:black">Belum Punya Akun ? <a href="{{route('register')}}"
