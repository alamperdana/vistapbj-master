            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="opd" class="col-md-4 col-form-label text-md-end">{{ __('OPD') }}</label>

                            <div class="col-md-6">
                                <input id="opd" type="text" class="form-control @error('opd') is-invalid @enderror" name="opd" value="{{ old('opd') }}" required autocomplete="opd" autofocus>
                                @error('opd')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
